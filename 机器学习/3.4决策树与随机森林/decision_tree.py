...
class DecisionTree(object):
    ...
    def decision_tree_function(self):
...
class TestCase(unittest.TestCase):
    ...
    def test_data_preprocessing_template(self):
        self.dt.data_preprocessing_template()

    def test_svm_function(self):
        self.dt.decision_tree_function()